        ...
        return () => h("div", { class: "vp-blog-infos" }, [
            ...
            active.value === "article"
                ? h("div", { class: "vp-sticky-article-wrapper" }, [
                    ...
                    h("hr"),
                    h("ul", { class: "vp-sticky-articles" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", { class: "vp-sticky-article" }, h(VPLink, { to: path }, () => info["t" /* ArticleInfoType.title */]))))),
                ])
